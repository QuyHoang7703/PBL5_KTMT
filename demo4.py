...
img = cv2.imread(r"C:\Users\QUYHOANG\Pictures\Screenshots\Screenshot 2024-04-17 224707.png")
...
for result in results:
    ...
    for box in boxes:
        ...
        W = box.xywh[0][2]
        H = box.xywh[0][3]
coord = np.array([[X, Y], [X2, Y], [X2, Y2], [X, Y2]])
# LpRegion = four_point_transform(img, coord)
#
# cv2.imshow("Before LP", LpRegion)
# cv2.waitKey(0)
