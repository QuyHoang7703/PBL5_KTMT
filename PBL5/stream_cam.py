...
# Hàm xử lý luồng camera và nhận diện biển số xe
# def generate_frames(stream_url, model, character_model):
...
#                     cv2.putText(frame, bien_so_du_doan, (int(X), int(Y) - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
#
...
stream_url_vao = "http://192.168.174.106:81/stream"
stream_url_ra = "http://192.168.174.134:81/stream"
...
def generate_frames(camera_url):
    while True:
        frame = next(process_camera_stream(camera_url, yolo_model, character_model))
        yield frame