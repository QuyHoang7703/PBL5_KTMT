    ...
    try:
        ...
        if results:
            ...
            if X != None and Y != None and W != None and H != None:
                ...
                T = threshold_local(V, 35, offset=3, method="gaussian")
                ...
                django_endpoint = 'http://your-django-server/receive_license_plate/'
                data_to_send = {"bien_so_du_doan": bien_so_du_doan}
                response = requests.post(django_endpoint, json=data_to_send)
                print(response.json())
