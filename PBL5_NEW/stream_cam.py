...
# Khởi tạo các mô hìnhhttp://192.168.234.134
stream_url_vao = "http://192.168.234.134:81/stream"
stream_url_ra = "http://192.168.234.106:81/stream"
            ...
            if X is not None and Y is not None and W is not None and H is not None:
                ...
                if candidates:
                    ...
                    if detection_confirmed:
                        url = 'http://192.168.234.130:5000/history-management/history'
